...
int main(int argc, char *argv[])
{
    ...
    unsigned short echoServPort,echoCliPort;     /* Echo server port */
    char *servIP, *cliIP;                    /* Server IP address (dotted quad) */
 ...
 int choix;
    ...
    // cliIP = argv[1];
    // echoCliPort = atoi(argv[2]);
    
    // servIP = argv[3];              First arg: server IP address (dotted quad) 
    // echoServPort = atoi(argv[4]);   /* Second arg: server Port */
